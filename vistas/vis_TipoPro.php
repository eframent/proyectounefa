...
$la_Nombres=Array("Codigo","Nombre","Estatus","Padre","Modulo","Holgura");
		...
		<form name="form1" action="../controladores/cor_TipoPro.php" method="POST">
			...
			<table>
				...
				<tr>
					...
					<td>
						<select name="Padre" onblur="validarHolgura()" >
				...
				<tr id="holgura">
					<td align="right"><label>Tiempo de holgura:</label></td>
					<td><input  type="text" name="Holgura" validar="solo numeros" value="<?php if($la_Campos['Holgura']!=""){print($la_Campos['Holgura']);}else{print('0');}?>" /></td>
				</tr>
				<tr>
					<td align="right"><label>Modulo:</label></td>
					<td><select validar=" "name="Modulo">
							<option value="-" selected="selected">Seleccione</option>
							<?php $lobj_Combo->fGenerar("SELECT * FROM modulo","mod_codigo","mod_nombre",$la_Campos['Modulo'],"")?>
						</select>
					</td>
				</tr>
				<tr>
