...
<body >
	...
	<div Contenedor>
		...
		<form name="form1" action="../controladores/cor_Rep_Bitacora.php" method="POST">
				...
				<tr>
					...
					<td align="left">
						<select  name="Op">
							...
							<option value="INSERT"	<?php if($la_Campos['Op']=='INSERT'){print("selected");} ?> >INSERT</option>
							<option value="UPDATE"  <?php if($la_Campos['Op']=='UPDATE'){print("selected");} ?> >UPDATE</option>
							<option value="DELETE"  <?php if($la_Campos['Op']=='DELETE'){print("selected");} ?> >DELETE</option>	
						</select>
					</td>
				<tr>
					...
					<td align="left">
						...
						<input type="button" name="Imprimir" value="PDF" onclick="location.href='pdf/PDF_Rep_Bitacora.php';">
						<input type="button" name="Imprimir2" value="Word" onclick="location.href='pdf/doc_xls_Bitacora.php?x=.doc';">
						<input type="button" name="Imprimir3" value="Excel" onclick="location.href='pdf/doc_xls_Bitacora.php?x=.xls';">
					</td>
				</tr>
