<?php
session_start();
$variable=$_SESSION['usuario']['Cargo'];
include_once("../clases/cls_ProyeccionSec.php");
include_once("../clases/cls_Cuerpo.php");
$lobj_Cuerpo = new cls_Cuerpo();
$lobj_Carga= new cls_ProyeccionSec;
$Nombre=$_GET['Nombre'];
$proceso=$lobj_Cuerpo->f_Proceso("PROYECCION");
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Proyeccion de Secciones</title>
	...
	<script type="text/javascript" src="JS/depuracionSecciones.js"></script>
		...
		function hideField(obj){
			...
			if(Field){
				if(Field.classList.contains('bajarCompleto')){
					...
					Field.childNodes[3].innerHTML="<div class='K' style='text-transform: capitalize;'>Pulse Una Materia Para Ver Sus Detalles</div>";
				}else{
