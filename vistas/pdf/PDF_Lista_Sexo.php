<?php
   ...
   require_once("../../clases/cls_Lista_Sexo.php");
   ...
   $lobjConstEst->fSetsbusqueda($buscar);
    ...
    if (count($laMatriz)>=1) {
       ...
       $lobjPdf->Ln();
  	   ...
  	   $lobjPdf->Cell(0,6,utf8_decode("LISTADO DE ESTUDIANTES POR SEXO"),0,1,"C");
       $lobjPdf->Ln();
       ...
       $lobjPdf->Cell(15,6,utf8_decode("Sexo"),1,1,"C");
       $n=1;
       for ($lix=0; $lix < count($laMatriz); $lix++) { 
         ...
         $lobjPdf->Cell(60,6,utf8_decode($laMatriz[$lix][3]." ".$laMatriz[$lix][4]),1,0,"C");
         $lobjPdf->Cell(15,6,utf8_decode($laMatriz[$lix][5]),1,1,"C");
         $n++;
        }        
    }else{
