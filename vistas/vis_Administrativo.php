...
$la_Nombres=Array("Cedula","Nombre1","Nombre2","Apellido1","Apellido2","Nombre_Usu","Nacio","Estatus","Correo");
...
<head>
	...
	<script>
		...
		laValor= new Array("checked","bloqueado","bloqueado","bloqueado","A<?php print($la_Campos['Cedula']);?>");
	</script>
</head>
<body onload="cargar(<?php if(isset($_GET['buscar'])) echo 1;else echo 0;?>)">
	...
	<div Contenedor>
		...
		<form name="form1" action="../controladores/cor_Administrativo.php" method="POST" >
			...
			<table>
				...
				<tr>
					<td align="right" colspan="1"><label>Nombre de Usuario:</label></td>
	...
	<?php $lobj_Cuerpo->f_Listar($la_listados,$la_Nombres,$la_Campos["pg"],$la_Campos["valor"],"Administrativo");?>
</body>
