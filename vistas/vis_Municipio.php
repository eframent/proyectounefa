...
$lsSql="select * from estado  where (borrado='I') order by idestado"; 
$la_listados=$_SESSION["matriz"];
unset($_SESSION["matriz"]);
$la_Nombres=Array("Codigo","Nombre","Estado","IDEstado","Estatus");
...
<body onload="cargar(<?php if(isset($_GET['buscar'])) echo 1;else echo 0;?>)">
	...
	<div Contenedor>
		...
		<form name="form1" action="../controladores/cor_Municipio.php" method="POST">
			...
			<table>
				...
				<tr>
					...
					<td>
						<select validar=" " name="Estado">
							<option value="-" selected="selected">Seleccione</option>
							<?php $lobjCombo->fGenerar($lsSql,"idestado","nombre_e",$la_Campos['Estado'],"")?>
						</select>
					</td>
				</tr>
				<tr>
	...
	<?php $lobj_Cuerpo->f_Listar($la_listados,$la_Nombres,$la_Campos["pg"],$la_Campos["valor"],"Municipio");?>
</body>
