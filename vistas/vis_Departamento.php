...
$la_Nombres=Array("Nombre","Estatus");
...
<body onload="cargar(<?php if(isset($_GET['buscar'])) echo 1;else echo 0;?>)">
	...
	<div Contenedor>
		<div formulario>
			<h2>Departamentos</h2>
		<form name="form1" action="../controladores/cor_Departamento.php" method="POST">
			<?php $lobj_Cuerpo->f_Control($la_Campos); ?>
			<table>
				<tr>
					<td align="right"><label>Nombre:</label></td>
					<td><input type="text" name="Nombre" validar="solo letras" value="<?php print($la_Campos['Nombre']);?>" onblur="f_PerderFocus();"/></td>
				</tr>
				<tr>
	...
	<?php $lobj_Cuerpo->f_Listar($la_listados,$la_Nombres,$la_Campos["pg"],$la_Campos["valor"],"Departamento");?>
</body>
