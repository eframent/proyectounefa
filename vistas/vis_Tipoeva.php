...
<body onload="cargar(<?php if(isset($_GET['buscar'])) echo 1;else echo 0;?>)">
	...
	<div Contenedor>
		<div formulario>
			<h2>Tipo de Evaluación Docente</h2>
		<form name="form1" action="../controladores/cor_Tipoeva.php" method="POST">
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="Nombre" validar="solo letras" value="<?php print($la_Campos['Nombre']);?>"/></td>
				</tr>
				<tr>
	...
	<?php $lobj_Cuerpo->f_Listar($la_listados,$la_Nombres,$la_Campos["pg"],$la_Campos["valor"],"Tipoeva");?>
</body>
