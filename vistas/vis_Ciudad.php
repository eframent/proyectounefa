...
$lsSql="select * from parroquia where (borrado='I') order by idparroquia"; 
$la_listados=$_SESSION["matriz"];
unset($_SESSION["matriz"]);
$la_Nombres=Array("Codigo","Nombre","Nombre_Parroquia","Parroquia","Estatus");
...
<body onload="cargar(<?php if(isset($_GET['buscar'])) echo 1;else echo 0;?>)">
	...
	<div Contenedor>
		...
		<form name="form1" action="../controladores/cor_Ciudad.php" method="POST">
			...
			<table>
				...
				<tr>
					...
					<td >
						<select  validar=" " name="Parroquia">
							<option value="-" selected="selected">Seleccione</option>
							<?php $lobjCombo->fGenerar($lsSql,"idparroquia","nombre_p",$la_Campos['Parroquia'],"")?>
						</select>
					</td>
				</tr>
				<tr>
	...
	<?php $lobj_Cuerpo->f_Listar($la_listados,$la_Nombres,$la_Campos["pg"],$la_Campos["valor"],"Ciudad");?>
</body>
