<?php 
include("../clases/cls_Departamento.php");
session_start();
if(array_key_exists(Operacion,$_POST))
{
	$laForm=$_POST;
	$lobj_Tip= new cls_Departamento();
...
if($laForm['Operacion']=="buscar")
{
	...
	header("location: ../vistas/vis_Departamento.php");
}
if($laForm['Operacion']!="buscar")
{
	$lb_Hecho=false;
	if($laForm['Operacion']=="lista"){
		...
		$_SESSION["Campos"]=$laForm;
		header("location: ../vistas/vis_Departamento.php?buscar");
	}
