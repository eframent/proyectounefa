...
class  cls_Confirmar_CINU extends  cls_Bitacora{
	...
	/**/		$cont=count($this->aa_Form['cedula'.$liX]);		echo("<br>".$cont.'  '.$this->aa_Form['cedula'.$liX]);	/**/
	...
	/**/						$usuario="V-".$this->aa_Form['cedula'.$liX];											/**/
	/**/						$contrasena=$this->f_EnvioContrasena($nombres,$this->aa_Matriz['correo'],$usuario);		/**/
	/**/					}else{																						/**/
	...
	/**/							}else{																				/**/
	/**/								echo "<br>rollback de planificacion";											/**/
	/**/								$this->f_RollBack();															/**/
	/**/							}																					/**/
	/**/						}																						/**/
	...
	/**/				$this->f_RollBack();																			/**/
	/**/			}																									/**/
	/**/			echo("<br>".'aqui2');}//fin de donde se verifica si viene los datos en blanco								/**/
	/**/		}else{																									/**/
	/**/			$ls_Sql9="DELETE FROM \"CINU\" WHERE(cedula='".$this->aa_Form['cedula'.$liX]."')";					/**/
	/**/			$lb_Hecho=$this->f_Ejecutar($ls_Sql9);																/**/
	/**/		}																										/**/
	/**/		}//fin del camino normal donde se guarda en las tablas 													/**/
	/**/		echo("<br>".'aqui');}//fin for																					/**/
	...
	/* Busca en la base de datos un registro en especifico y trae todos sus campos										  */
	/**********************************************************************************************************************/
		public function f_EnvioContrasena($nombres,$correo,$usuario){	
